...
func (c *greeterClient) SayHello(ctx context.Context, opts ...grpc.CallOption) (Greeter_SayHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/streamclientservice.Greeter/SayHello", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *greeterSayHelloClient) Send(m *RpcRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterSayHelloClient) CloseAndRecv() (*RpcResponse, error) {
...
func (x *greeterSayHelloServer) SendAndClose(m *RpcResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterSayHelloServer) Recv() (*RpcRequest, error) {
	m := new(RpcRequest)
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "streamclientservice.Greeter",
